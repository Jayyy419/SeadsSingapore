      ...
      <section className="grid gap-4 lg:grid-cols-3">
        {events.map((event) => (
          <article key={event.title} className="section-card p-6">
            <p className="text-xs font-bold uppercase tracking-wide text-[#ff6b2c]">{event.type}</p>
            ...
            <button
              type="button"
              className="mt-4 rounded-full bg-[#13212f] px-4 py-2 text-sm font-semibold text-white"
            >
              Join Our Events
            </button>
          </article>
